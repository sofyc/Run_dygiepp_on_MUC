...
role_names = ["incident_type", "incident_date", "incident_location", "PerpInd", "PerpOrg", "Target", "Weapon", "Victim"]
...
if __name__ == "__main__":
    ...
    for line in input_file:
        ...
        if role_names[0] == "incident_type":
            docs[ex["doc_key"].split("-")[0][-1] + ex["doc_key"].split("-")[-1]] = doc
        else:
            docs[ex["doc_key"]] = doc
