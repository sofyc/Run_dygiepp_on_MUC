...
if __name__ == "__main__":
    ...
    with open(args.pred_file, encoding="utf-8") as f:
        ...
        for docid in out_dict:
            ...
            for idx, temp in enumerate(preds[docid]):
                if temp["incident_type"] != []:
                    temp["incident_type"] = temp["incident_type"][0][0]
                if type(temp["incident_type"]) != str:
                    preds[docid][idx]["incident_type"] = "attack"
    ...
    with open("./data/MUC/docids_event_n.json", encoding="utf-8") as f:
